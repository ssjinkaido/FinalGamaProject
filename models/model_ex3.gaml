...
experiment exp_params type: batch repeat: 8 until: (nb_butterfly=0) or (cycle > 200) {
	parameter "color_changed_type" var:color_changed_type min: 1 max: 5 step: 1;
	permanent {
		display raise_level type:2d{
			chart "Butterfly chart" type: series 
				x_serie_labels: (color_changed_type) x_label: 'type of environment'{						
